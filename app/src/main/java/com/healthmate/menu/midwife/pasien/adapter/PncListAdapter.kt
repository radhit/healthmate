...
class PncListAdapter(private val mContext: Context) : RecyclerView.Adapter<PncListAdapter.ViewHolder>(){
    var lists: ArrayList<PncModel> = arrayListOf()
