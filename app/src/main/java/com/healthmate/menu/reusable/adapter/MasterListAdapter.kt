...
class MasterListAdapter() : RecyclerView.Adapter<MasterListAdapter.ViewHolder>(){
    var lists: ArrayList<MasterListModel> = arrayListOf()
    fun updateLists(newData: ArrayList<MasterListModel>){
        lists.clear()
