...
class MasterListActivity : BaseActivity() {
    ...
    private fun getKeadaan() {
        ...
        arrays.add(MasterListModel("4","Lochea berbau"))
        arrays.add(MasterListModel("5","Pendarahan"))
        arrays.add(MasterListModel("6","Demam"))
        arrays.add(MasterListModel("7","Kejang"))
        arrays.add(MasterListModel("7","Segera menangis"))
        arrays.add(MasterListModel("7","Menangis beberapa saat"))
        arrays.add(MasterListModel("7","Tidak menangis"))
        arrays.add(MasterListModel("7","Seluruh tubus kemerahan"))
        arrays.add(MasterListModel("7","Anggota gerak kebiruan"))
        arrays.add(MasterListModel("7","Seluruh tubuh biru"))
