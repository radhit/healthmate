...
class ListHospitalAdapter() : RecyclerView.Adapter<ListHospitalAdapter.ViewHolder>(){
    var lists: ArrayList<Hospital> = arrayListOf()
    fun updateLists(newData: ArrayList<Hospital>){
        lists.clear()
